...
#include "ipv6-olsr-routing-protocol.h"
...
{
  static TypeId tid = TypeId ("ns3::ipv6_olsr::RoutingProtocol")
...
RoutingProtocol::SetIpv4 (Ptr<Ipv4> ipv4)
{
  NS_ASSERT (ipv4 != 0);
  NS_ASSERT (m_ipv4 == 0);
  NS_LOG_DEBUG ("Created ipv6_olsr::RoutingProtocol");
...
RoutingProtocol::RecvOlsr (Ptr<Socket> socket)
{
  ...
  ipv6_olsr::PacketHeader olsrPacketHeader;
      ...
      if (duplicated == NULL)
        {
          switch (messageHeader.GetMessageType ())
            {
            case ipv6_olsr::MessageHeader::HELLO_MESSAGE:
            ...
            case ipv6_olsr::MessageHeader::TC_MESSAGE:
              NS_LOG_DEBUG (Simulator::Now ().GetSeconds ()
                            << "s OLSR node " << m_mainAddress
      ...
      if (do_forwarding)
        {
          ...
          if (messageHeader.GetMessageType ()  != ipv6_olsr::MessageHeader::HELLO_MESSAGE)
            {
...
///
void
RoutingProtocol::ProcessHello (const ipv6_olsr::MessageHeader &msg,
                               const Ipv4Address &receiverIface,
                               const Ipv4Address &senderIface)
{
  NS_LOG_FUNCTION (msg << receiverIface << senderIface);

  const ipv6_olsr::MessageHeader::Hello &hello = msg.GetHello ();
...
///
void
RoutingProtocol::ProcessTc (const ipv6_olsr::MessageHeader &msg,
                            const Ipv4Address &senderIface)
{
  const ipv6_olsr::MessageHeader::Tc &tc = msg.GetTc ();
...
///
void
RoutingProtocol::ProcessMid (const ipv6_olsr::MessageHeader &msg,
                             const Ipv4Address &senderIface)
{
  const ipv6_olsr::MessageHeader::Mid &mid = msg.GetMid ();
  Time now = Simulator::Now ();
...
///
void
RoutingProtocol::ProcessHna (const ipv6_olsr::MessageHeader &msg,
                             const Ipv4Address &senderIface)
{

  const ipv6_olsr::MessageHeader::Hna &hna = msg.GetHna ();
  Time now = Simulator::Now ();
  ...
  for (std::vector<ipv6_olsr::MessageHeader::Hna::Association>::const_iterator it = hna.associations.begin ();
...
///
void
RoutingProtocol::ForwardDefault (ipv6_olsr::MessageHeader olsrMessage,
...
///
void
RoutingProtocol::QueueMessage (const ipv6_olsr::MessageHeader &message, Time delay)
{
...
RoutingProtocol::SendQueuedMessages ()
{
  ...
  for (std::vector<ipv6_olsr::MessageHeader>::const_iterator message = m_queuedMessages.begin ();
...
RoutingProtocol::SendHello ()
{
  ...
  ipv6_olsr::MessageHeader::Hello &hello = msg.GetHello ();

  hello.SetHTime (m_helloInterval);
  hello.willingness = m_willingness;

  std::vector<ipv6_olsr::MessageHeader::Hello::LinkMessage>
  ...
  for (LinkSet::const_iterator link_tuple = links.begin ();
       link_tuple != links.end (); link_tuple++)
    {
      ...
      ipv6_olsr::MessageHeader::Hello::LinkMessage linkMessage;
...
RoutingProtocol::SendTc ()
{
  ...
  ipv6_olsr::MessageHeader::Tc &tc = msg.GetTc ();
  tc.ansn = m_ansn;
...
{
	ipv6_olsr::MessageHeader msg;
	ipv6_olsr::MessageHeader::Mid &mid = msg.GetMid ();
...
RoutingProtocol::SendHna ()
{
  ...
  msg.SetHopCount (0);
  msg.SetMessageSequenceNumber (GetMessageSequenceNumber ());
  ipv6_olsr::MessageHeader::Hna &hna = msg.GetHna ();

  std::vector<ipv6_olsr::MessageHeader::Hna::Association> &associations = hna.associations;
  ...
  for (Associations::const_iterator it = localHnaAssociations.begin ();
    ...
    {
	  ipv6_olsr::MessageHeader::Hna::Association assoc = { it->networkAddr, it->netmask};
...
void
RoutingProtocol::LinkSensing (const ipv6_olsr::MessageHeader &msg,
                              const ipv6_olsr::MessageHeader::Hello &hello,
                              const Ipv4Address &receiverIface,
                              const Ipv4Address &senderIface)
{
  Time now = Simulator::Now ();
  ...
  for (std::vector<ipv6_olsr::MessageHeader::Hello::LinkMessage>::const_iterator linkMessage =
...
void
RoutingProtocol::PopulateNeighborSet (const ipv6_olsr::MessageHeader &msg,
                                      const ipv6_olsr::MessageHeader::Hello &hello)
{
...
void
RoutingProtocol::PopulateTwoHopNeighborSet (const ipv6_olsr::MessageHeader &msg,
                                            const ipv6_olsr::MessageHeader::Hello &hello)
{
  Time now = Simulator::Now ();
  ...
  for (LinkSet::const_iterator link_tuple = m_state.GetLinks ().begin ();
       link_tuple != m_state.GetLinks ().end (); link_tuple++)
    {
      ...
      typedef std::vector<ipv6_olsr::MessageHeader::Hello::LinkMessage> LinkMessageVec;
...
/// a new received HELLO message (following RFC 3626).
void
RoutingProtocol::PopulateMprSelectorSet (const ipv6_olsr::MessageHeader &msg,
                                         const ipv6_olsr::MessageHeader::Hello &hello)
{
  NS_LOG_FUNCTION (this);
