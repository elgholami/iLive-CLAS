...
#include "ipv6-olsr-header.h"
#include "ns3/test.h"
#include "ipv6-olsr-state.h"
#include "ipv6-olsr-repositories.h"
...
private:
  ...
  ipv6_olsr::MessageList m_queuedMessages;
  Timer m_queuedMessagesTimer; // timer for throttling outgoing messages

  void ForwardDefault (ipv6_olsr::MessageHeader olsrMessage,
                       DuplicateTuple *duplicated,
                       const Ipv4Address &localIface,
                       const Ipv4Address &senderAddress);
  void QueueMessage (const ipv6_olsr::MessageHeader &message, Time delay);
  ...
  void ProcessHello (const ipv6_olsr::MessageHeader &msg,
                     const Ipv4Address &receiverIface,
                     const Ipv4Address &senderIface);
  void ProcessTc (const ipv6_olsr::MessageHeader &msg,
                  const Ipv4Address &senderIface);
  void ProcessMid (const ipv6_olsr::MessageHeader &msg,
                   const Ipv4Address &senderIface);
  void ProcessHna (const ipv6_olsr::MessageHeader &msg,
                   const Ipv4Address &senderIface);

  void LinkSensing (const ipv6_olsr::MessageHeader &msg,
                    const ipv6_olsr::MessageHeader::Hello &hello,
                    const Ipv4Address &receiverIface,
                    const Ipv4Address &sender_iface);
  void PopulateNeighborSet (const ipv6_olsr::MessageHeader &msg,
                            const ipv6_olsr::MessageHeader::Hello &hello);
  void PopulateTwoHopNeighborSet (const ipv6_olsr::MessageHeader &msg,
                                  const ipv6_olsr::MessageHeader::Hello &hello);
  void PopulateMprSelectorSet (const ipv6_olsr::MessageHeader &msg,
                               const ipv6_olsr::MessageHeader::Hello &hello);
