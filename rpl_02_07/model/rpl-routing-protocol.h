...
#define RPL_STAT(code)
	...
	std::list<rpl_dag_t> parents_list;
	rpl_dag_t *m_dag;
...
private:
	...
	/// Multicast callback for own packets
	MulticastForwardCallback m_mcb;
...
private:
	...
	void
	RPLSend(Ptr<Packet> packet, Ipv6Address src, Ipv6Address dst, uint8_t ttl);
